...
import com.paylabs.payin.models.Header;
...
public class ApiRequest {
  ...
  private static String date = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.S'+07:00'").format(new Date());
  ...
  public static String create(JSONObject jsonBody, String path){
    try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
      ...
      Map<String, String> header = Header.create(date, signature, jsonBody.getString("requestId"));
